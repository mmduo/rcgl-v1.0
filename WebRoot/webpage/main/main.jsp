...
a:hover {
 ...
 <body class="easyui-layout" style="overflow-y: hidden" scroll="no">
  <!-- 顶部-->
  <div region="north" border="false" title="日常管理系统_V0.1版本" style="BACKGROUND:#E6E6FA;height: 85px; padding: 1px; overflow: hidden;">
  ...
  <div region="south" border="false" style="height: 25px; overflow: hidden;">
    ...
    &copy; 版权所有
     <span class="tip"><a href="##" title="日常管理系统_V0.1版本">日常管理系统_V0.1版本</a> (推荐谷歌浏览器，获得更快响应速度)  技术支持:<a href="#" title="ZS">ZS</a></span>
   </div>
  </div>
