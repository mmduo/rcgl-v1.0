...
#login .logo {
 ...
 <body>
  ...
  <div id="login">
   ...
   <div class="inner">
    <div class="logo">
     <img src="plug-in/login/images/toplogo-jeecg3.png"/>
    </div>
    <div class="formLogin">
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="#" title="日常管理系统_V0.1版本">日常管理系统_V0.1版本</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="ZS">ZS</a></span>
   </div>
  </div>
    <!-- Link JScript-->
