  ...
  <t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveTypeGroup">
   ...
   <fieldset class="step">
    ...
    <label class="Validform_label">
     ...
     <input name="typegroupcode" class="inputxt" ajaxurl="systemController.do?checkTypeGroup&code=${typegroup.typegroupcode }"  value="${typegroup.typegroupcode }" datatype="s3-8">
