...
<script type="text/javascript" src="plug-in/common/zzcyljList.js"></script>

<table width="100%" id="zzcyljList" toolbar="#zzcyljListtb"></table>
<div id="zzcyljListtb" style="padding:3px; ">
	<div name="searchColums">
		...
		<span style="display:-moz-inline-box;display:inline-block;width: 80px;text-align:right;">日期：</span>
			<input name="zzcyljqdate" class="easyui-datebox"></span>
	</div>
	<div style="height:30px;" class="datagrid-toolbar">
		<span style="float:left;">
		<a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit"
			onclick="zzcyljList.expFiles()">导出</a>
		<a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit"
			onclick="zzcyljList.expExcelFiles()">导出excel</a>
		</span>
		<span style="float:right">
		<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="zzcyljList.listSearch()">查询</a>
		<!-- <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="zzcyljListsearch()">查询</a> -->
		<a href="#" class="easyui-linkbutton" iconCls="icon-reload"	onclick="searchReset('zzcyljList')">重置</a>
		</span>
	</div>
</div>