...
<script type="text/javascript" src="plug-in/common/zzcwljList.js"></script>

<table width="100%" id="zzcwljList" toolbar="#zzcwljListtb"></table>
<div id="zzcwljListtb" style="padding:3px; ">
	...
	<div style="height:30px;" class="datagrid-toolbar">
		...
		<!-- <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="zzcwljListsearch()">查询</a> -->
		<a href="#" class="easyui-linkbutton" iconCls="icon-reload"	onclick="searchReset('zzcwljList')">重置</a>
		</span>
	</div>
</div>