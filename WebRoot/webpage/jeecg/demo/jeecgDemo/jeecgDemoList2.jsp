...
<%@include file="/context/mytags.jsp"%>
 <div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoList1" title="DEMO示例列表" autoLoadData="true" actionUrl="jeecgDemoController.do?datagrid1" sortName="userName"  fitColumns="true" idField="id" fit="true" queryMode="group">
