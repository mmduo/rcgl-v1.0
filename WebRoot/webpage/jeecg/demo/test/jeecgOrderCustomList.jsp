...
<table border="0" cellpadding="2" cellspacing="0" id="jeecgOrderCustom_table">
	...
	<c:if test="${fn:length(jeecgOrderCustomList)  <= 0 }">
			<tr>
				...
				<td align="left">
<%--				<input name="jeecgOrderCustomList[0].gocSex" maxlength="2" type="text"  style="width:120px;"/>--%>
	...
	<c:if test="${fn:length(jeecgOrderCustomList)  > 0 }">
		<c:forEach items="${jeecgOrderCustomList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="left">
<%--				<input name="jeecgOrderCustomList[${stuts.index }].gocSex" maxlength="2" type="text" value="${poVal.gocSex }" style="width:120px;"/>--%>
